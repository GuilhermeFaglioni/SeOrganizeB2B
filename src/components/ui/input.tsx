...
export const Input = forwardRef<HTMLInputElement, InputProps>(function Input(rawProps, ref) {
  ...
  const statusId = status === "unvalidated" ? `${resolvedId}-status` : undefined;
  ...
  return (
    <BalsaThemeContext.Provider value={theme}>
      ...
      >
        {label ? (
          <label htmlFor={resolvedId} className={fieldLabelClasses}>
            {label}
